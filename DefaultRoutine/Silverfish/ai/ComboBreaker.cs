    ...
    public class ComboBreaker
    {
        ...
        class combo
        {
            ...
            public combo(string s)
            {
                //int i = 0;
                this.neededMana = 0;
                requiredWeapon = CardDB.cardNameEN.unknown;
                    ...
                    foreach (string crdl in s.Split(';')) //ding.Split
                    {
                        ...
                        if (this.twoTurnCombo)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    this.requiredWeapon = lolcrd.nameEN;
                                }
            ...
            public int isMultiTurnComboTurn1(List<Handmanager.Handcard> hand, int omm, List<Minion> ownmins, CardDB.cardNameEN weapon)
            {
                ...
                if (cardsincombo == this.combot1len)
                {
                    ...
                    if (requiredWeapon != CardDB.cardNameEN.unknown && requiredWeapon != weapon) return 1;
        ...
        public int checkIfComboWasPlayed(Playfield p)
        {
            ...
            CardDB.cardNameEN weapon = p.ownWeapon.name;

...
{
	class Sim_BAR_326 : SimTemplate //* 剃刀沼泽兽王 Razorfen Beastmaster
	{
        //<b>Deathrattle:</b> Summon a <b>Deathrattle</b> minion that costs (4) or less from your hand.
        //<b>亡语：</b>从你的手牌中召唤一个法力值消耗小于或等于（4）点的<b>亡语</b>随从。
        public override void onDeathrattle(Playfield p, Minion m)
        {
            if (m.own)
            {
                ...
                {
                    if (hc.manacost <= 4 && hc.card.deathrattle && hc.card.type == CardDB.cardtype.MOB)
                    {
